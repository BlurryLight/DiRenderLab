...
public:
    ...
    void update_bind_slot(const VboPtr &vbo, GLuint vbo_slot,GLuint first_element_offset, GLint num_offset, size_t elem_size) {
        ...
        // now we set the vbo
        glVertexArrayVertexBuffer(obj_, vbo_slot, *vbo, first_element_offset, elem_size * num_offset);
        vbos_.push_back(vbo);
        changed_ = false;
    }
    void update_bind_slot(const VboPtr &vbo, GLuint vbo_slot,const EboPtr &ebo, GLuint first_element_offset, GLint num_offset,size_t elem_size) {
        update_bind_slot(vbo,vbo_slot,first_element_offset,num_offset,elem_size);
    ...
    void update_bind(const VboPtr &vbo, const EboPtr &ebo, GLuint first_element_offset, GLint num_offset,size_t elem_size) {
